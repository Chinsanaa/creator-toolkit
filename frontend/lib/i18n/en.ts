export const translations: Record<string, string> = {
  ...
  username_immutable_hint: 'Username cannot be changed.',
  change_password: 'Change password',
  change_password_subtitle: 'Use a strong password you have not used elsewhere.',
  password_changed: 'Password changed successfully.',
  password_change_failed: 'Failed to change password.',
  email_verification: 'Email verification',
  email_verification_subtitle: 'Verify your email to secure your account. This is optional for using the app.',
  email_verified: 'Your email is verified.',
  email_verified_success: 'Email verified successfully.',
  send_verification_code: 'Send code',
  resend_code: 'Resend code',
  verification_code: 'Verification code',
  verification_code_sent: 'If email is configured, a 6-digit code was sent to your inbox.',
  verify_email: 'Verify email',
  verify_your_email: 'Verify your email',
  verify_email_banner: 'Verify your email to secure your account.',
  continue_without_verifying: 'Continue without verifying',
  dismiss: 'Dismiss',
  sending: 'Sending…',
  verifying: 'Verifying…',
  legal: 'Legal',
